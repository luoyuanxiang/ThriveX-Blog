    ...
    <>
      ...
      <div className='bg-white dark:bg-black-b border-t dark:border-black-b px-10 transition-colors'>
        <div className="flex justify-center items-center py-4">
          <img src={user?.avatar === '' || user?.avatar === null || user?.avatar === undefined ? defaultUserAvatar.src : user?.avatar} alt='作者头像' className='w-20 h-20 rounded-full mr-8 avatar-animation shadow-[5px_11px_30px_20px_rgba(255,255,255,0.1)]' />
