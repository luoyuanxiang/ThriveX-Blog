...
export default async () => {
    ...
    return (
        <>
            <div
                className='sticky bottom-0 z-30 translate-y-[25px] flex justify-center w-full bg-cover bg-center after:content-[""] after:w-full after:h-[60%] after:absolute after:bottom-[25px] after:left-0 after:bg-[linear-gradient(to_top,#fff,transparent)] dark:after:bg-[linear-gradient(to_top,#2c333e,transparent)]'>
                <div className="flex justify-center lg:w-[950px] xl:w-[1200px] mx-auto">
                    <Image src={animals} alt="动物" width={660.34} height={79.99}
                ...
                <div className="py-4 border-t dark:border-black-a  ">
                    <Tooltip content="一款免费、开源、年轻、高颜值的现代化博客管理系统">
                        <div className="flex justify-center items-center space-x-3">
                            <img src="https://bu.dusays.com/2024/11/17/6739adf188f64.png" width={30} height={30}
                                 alt="ThriveX 博客管理系统"/>
                            <Link href="https://github.com/LiuYuYang01/ThriveX-Admin" target="_blank"
