                ...
                <div className="w-full pt-2.5 mt-2 min-h-[120px] space-y-4">
                    {list?.map((item, index) => (
                        <div key={index}
                            ...
                            <span
                                className='ranking absolute top-2.5 left-[-16px] w-[30px] h-[25px] pl-[7px] text-white rounded-tr-full rounded-br-full font-black box-border after:content-[""] after:absolute after:bottom-[-5px] after:left-0 after:w-0 after:h-0 after:border-[5px] after:border-solid'>{index + 1}</span>
                        </div>
                    ))}
                </div>
            </div>
