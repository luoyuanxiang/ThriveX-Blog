    ...
    return (
        <div className="space-y-4">
            {data?.result?.map((item, index) => (
                <div key={item.id}
                     className="relative overflow-hidden flex h-[190px] md:h-60 lg:h-52 xl:h-60 bg-black-b tw_container">
                    {index % 2 === 0 && (
                        <div
                    ...
                    <div className="relative w-full sm:w-[65%] py-5 px-5 sm:px-10 lg:px-5 xl:px-10 z-20">
                        <Link href={`/article/${item.id}`}
                              className="flex flex-col justify-between h-full text-center sm:text-start">
                            ...
                            <div
                                className={`flex ${index % 2 === 0 ? 'sm:justify-start' : 'sm:justify-end'} justify-center pt-5 text-end space-x-4 sm:space-x-8`}>
                                <div className="flex items-center text-xs text-white">
                  <span className="pr-1">
                    <IoTimeOutline
                        className="p-1 mt-[-2px] mr-[3px] text-[23px] text-white rounded-full align-middle bg-[#539dfd]"/>
                  </span>
                  ...
                  <span className="pr-1">
                    <RiFireLine
                        className="p-1 mt-[-2px] mr-[3px] text-[23px] text-white rounded-full align-middle bg-[#eb373a]"/>
                  </span>
                                    <span>{item.view}</span>
                                </div>
                  ...
                  <span className="pr-1">
                    <GoTag
                        className="p-1 mt-[-2px] mr-[3px] text-[23px] text-white rounded-full align-middle bg-[#f5a630]"/>
                  </span>
