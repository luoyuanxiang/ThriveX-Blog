                ...
                <ModalContent>
                    {() => (
                        <>
                            ...
                            <ModalBody>
                                <div
                                    className="mx-auto mb-4 p-3 space-y-2 border-l-[3px] border-primary bg-[#ecf7fe] rounded-md text-sm text-black-b">
                                    <p>1、网站无任何违法乱纪的内容</p>
                                ...
                                <Controller
                                    ...
                                    render={({field}) => (
                                        <>
                                            <Input {...field} type="text" label="网站名称" variant="bordered"
                                                   placeholder="示例：宇阳" isInvalid={!!errors.title?.message}
                                                   errorMessage={errors.title?.message} onBlur={() => trigger('title')}
                                ...
                                <Controller
                                    ...
                                    render={({field}) => (
                                        <>
                                            <Textarea {...field} label="网站介绍" variant="bordered"
                                ...
                                <Controller
                                    ...
                                    render={({field}) => (
                                        <>
                                            <Input {...field} type="text" label="图片地址" variant="bordered"
                                                   placeholder="示例：https://liuyuyang.net/avatar.jpg"
                                                   isInvalid={!!errors.image?.message}
                                                   errorMessage={errors.image?.message} onBlur={() => trigger('image')}
                                                   classNames={{inputWrapper}}/>
                                        </>
                                    )}
                                />
                                ...
                                <Controller
                                    ...
                                    render={({field}) => (
                                        <>
                                            <Input {...field} type="text" label="网站地址" variant="bordered"
                                                   placeholder="示例：https://liuyuyang.net/"
                                                   isInvalid={!!errors.url?.message} errorMessage={errors.url?.message}
                                                   onBlur={() => trigger('url')} classNames={{inputWrapper}}/>
                                        </>
                                    )}
                                />
                                ...
                                <Controller
                                    ...
                                    render={({field}) => (
                                        <>
                                            <Input {...field} type="text" label="邮箱（选填）" variant="bordered"
                                                   placeholder="示例：liuyuyang1024@yeah.net"
                                                   isInvalid={!!errors.email?.message}
                                                   errorMessage={errors.email?.message} onBlur={() => trigger('email')}
                                                   classNames={{inputWrapper}}/>
                                        </>
                                    )}
                                />
                                ...
                                <Controller
                                    ...
                                    render={({field}) => (
                                        <>
                                            <Input {...field} type="text" label="订阅地址（选填）" variant="bordered"
                                                   placeholder="示例：https://liuyuyang.net/index.php/feed/"
                                                   isInvalid={!!errors.rss?.message} errorMessage={errors.rss?.message}
                                                   onBlur={() => trigger('rss')} classNames={{inputWrapper}}/>
                                        </>
                                    )}
                                />
                            ...
                            <ModalFooter>
                                <Button color="primary" isLoading={loading} onPress={() => handleSubmit(onSubmit)()}
                                        className="w-full">
                                    加入
                                </Button>
                            </ModalFooter>
