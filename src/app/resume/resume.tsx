...
export default ({data}: { data: Resume }) => {
    ...
    return (
        <>
            ...
            <div
                className="min-h-screen py-8 mt-[60px] px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
                <motion.div initial="hidden" animate="visible" variants={containerVariants}
                        ...
                        <div className="mt-8 px-8 pb-8 relative">
                            <div className="flex flex-col md:flex-row items-center gap-6">
                                <motion.div initial={{scale: 0.8}} animate={{scale: 1}} transition={{duration: 0.5}}
                                            className="relative flex justify-center items-center w-32 h-32 rounded-full overflow-hidden bg-white shadow-xl border-transparent border-4 dark:border-gray-700">
                                    <div
                                        className="flex justify-center items-center w-[98%] h-[98%] rounded-full overflow-hidden">
                                ...
                                <div className="flex-1 text-center md:text-left">
                                    ...
                                    <div
                                        className="flex flex-wrap justify-center md:justify-start gap-4 text-gray-600 dark:text-gray-300 mb-4">
                    <span className="flex items-center text-sm">
                      ...
                      <span className="font-medium mr-1">地点:</span>
                                    ...
                                    <div
                                        className="flex flex-wrap justify-center md:justify-start gap-4 text-gray-700 dark:text-gray-300">
                                        <a href={`tel:${personalInfo?.contact?.phone}`}
                                           className="flex items-center hover:text-blue-600 text-sm">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-1 space-y-6">
                            ...
                            <motion.div variants={itemVariants}
                                ...
                                <div className="flex flex-wrap gap-2 mb-4 text-gray-600">
                                    {skillTags.map((tag, index) => (
                                        <p key={index}
                                           className="dark:bg-blue-900/30 py-1 rounded-full text-sm font-medium hover:text-blue-600 cursor-pointer">
                                            {tag.name}
                                        </p>
                                    ))}
                                </div>
                            ...
                            <motion.div variants={itemVariants}
                                ...
                                <div className="">
                                    <div
                                        className="flex justify-between mb-3 pb-1.5 border-b border-gray-100 dark:border-gray-700">
                      ...
                      {education?.period}
                                    ...
                                    <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-1 text-sm">
                                        {education?.achievements?.map((achievement, index) => (
                                            <li key={index} className="flex items-center">
                                                <span
                                                    className="flex items-center justify-center bg-blue-500 min-w-1.5 min-h-1.5 mr-2 rounded-full"></span>
                            ...
                            <motion.div variants={itemVariants}
                                ...
                                <div className="space-y-3">
                                    ...
                                    {links?.csdn && (
                                        <a href={links.csdn} target="_blank" rel="noopener noreferrer"
                                           className="flex items-center text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 text-sm font-medium transition-colors">
                            ...
                            <motion.div variants={itemVariants}
                                ...
                                <div className="space-y-6">
                                    {workExperience?.map((job, index) => (
                                        <div key={index}
                                             className="relative pl-6 pb-6 border-l-2 border-blue-200 dark:border-blue-900">
                                            <div
                                                className="absolute left-[-7px] top-0 w-3 h-3 rounded-full bg-blue-500 ring-4 ring-blue-100 dark:ring-blue-900"></div>
                                            <div className="flex flex-wrap justify-between items-start mb-1">
                                                <h4 className="text-md font-bold text-gray-900 dark:text-white">{job.company}</h4>
                                                <span
                                                    className="text-xs font-medium text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 px-2 py-1 rounded mt-1 md:mt-0">{job.period}</span>
                                            </div>
                                ...
                                <div className="space-y-6">
                                    {projects?.map((project, index) => (
                                        <div key={index}
                                            ...
                                            <div
                                                className="bg-gray-50 dark:bg-gray-700/50 p-4 border-b border-gray-100 dark:border-gray-700">
                                                <div className="flex flex-wrap justify-between items-start mb-1">
                                                    <h4 className="text-md font-bold text-gray-900 dark:text-white">{project.name}</h4>
                                                    <span
                                                        className="text-xs font-medium text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 px-2 py-1 rounded mt-1 md:mt-0">{project.period}</span>
                                                </div>
                                            ...
                                            <div className="p-4 space-y-3 text-sm">
                                                ...
                                                {project.techStack && (
                                                    <div>
                                                        ...
                                                        <div
                                                            className="text-gray-600 dark:text-gray-300 text-sm flex flex-wrap gap-2">
                                                            {typeof project.techStack === 'string' ? (
                                                                project.techStack
                                                            ) : (
                                                                <>
                                                                    <span
                                                                        className="px-2 py-0.5 rounded text-xs">前端: {project.techStack.frontend}</span>
                                                                    <span
                                                                        className="px-2 py-0.5 rounded text-xs">后端: {project.techStack.backend}</span>
                                                                    <span
                                                                        className="px-2 py-0.5 rounded text-xs">部署: {project.techStack.deployment}</span>
                                                                </>
                                                            )}
                                                        </div>
                                                    </div>
