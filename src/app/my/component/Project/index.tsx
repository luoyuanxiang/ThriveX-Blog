            ...
            <div data-aos="zoom-in" className="character pb-20">
                ...
                <div className="w-[80%] xl:w-[1200px] mx-auto">
                    <div className="flex w-full flex-col">
                        <Tabs aria-label="Options" placement="top" classNames={{
                            tabList: 'dark:bg-black-b',
                            tabWrapper: 'flex flex-col',
                            base: 'justify-center',
                            tab: '[&>span]:dark:bg-[#3a4250]'
                        }}>
                            {data?.map((item, index) => (
                                    ...
                                    <Card>
                                        <CardBody className="flex-col md:flex-row md:space-x-10 py-5 dark:bg-black-b  ">
                                            <div className="sticky top-0 w-full md:w-2/6 px-4">
                                                ...
                                                <div
                                                    className="grid grid-cols-2 gap-2 p-2.5 border dark:border-[#444e5d] rounded-xl  ">
                                                    <PhotoProvider>
                                                        {item.images?.map((img, index) => (
                                                            <PhotoView key={index} src={img || ''}>
                                                                <img src={img} alt="作品图片"
                                                                     className="border dark:border-[#444e5d] dark hover:scale-[1.2] rounded-lg cursor-pointer transition-transform"/>
                                                            </PhotoView>
                                                        ))}
                                                    </PhotoProvider>
                                                </div>
                                            ...
                                            <div
                                                className="overflow-auto w-full md:w-4/6 h-60 pl-4 pr-2.5 pb-8 mt-6 md:mt-0 text-sm space-y-8">
                                                <div>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="space-y-2">
                                                        <div>
                                                            ...
                                                            <a href={item.front.url} target="_blank"
                                                               className="text-xs text-primary" rel="noreferrer">
                                                                {item.front.url}
                                                            </a>
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <a href={item.control.url} target="_blank"
                                                               className="text-xs text-primary" rel="noreferrer">
                                                                {item.control.url}
                                                            </a>
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <a href={item.backend.url} target="_blank"
                                                               className="text-xs text-primary" rel="noreferrer">
                                                                {item.backend.url}
                                                            </a>
                                                        </div>
