        ...
        <>
            <div data-aos="zoom-in" className="mt-8 sm:mt-16  ">
                <div className="flex flex-col-reverse sm:flex-row justify-between items-center">
                    <div
                        className="w-full text-center sm:text-start sm:w-6/12 mt-6 sm:mt-0 text-[#353a40] dark:text-[#fff]">
                        ...
                        <div
                            className="text-sm text-[#666] dark:text-[#8c9ab1] leading-6 lg:leading-8">{data?.introduction}</div>
                    </div>
