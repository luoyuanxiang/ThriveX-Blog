        ...
        <div data-aos="fade-down" className="w-full md:w-7/12 flex flex-col mr-0 md:mr-20">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center">
                <div className="flex sm:block w-[40%]">
                    ...
                    <Link href="https://www.16personalities.com/ch/infj-人格"
                          className="block w-full mt-2 text-center text-[#666] text-xs hover:text-[#33a474]">
                        了解一下
                    </Link>
                </div>
                        ...
                        return (
                            <div key={index} className="flex justify-center items-center">
                                ...
                                <div className="relative w-full max-w-md">
                                    ...
                                    <div
                                        className="absolute -top-[25px] -translate-x-1/2 left-0 h-full flex items-center justify-center"
                                        style={{left: `${value}%`}}>
                    <span className={`flex items-center text-[${color}]`}>
                      {value}%
                      <Tooltip content={content}>
                        <BiQuestionMark
                            className="w-5 h-5 ml-2 rounded-full p-[2px] bg-[#eee] dark:bg-black-b cursor-pointer"/>
                      </Tooltip>
                    </span>
                                    </div>
                                </div>
                                ...
                                <span
                                    className="text-end min-w-[80px] dark:text-[#8c9ab1] text-xs sm:text-base">{text2}</span>
                            </div>
                        );
                    })}
                </div>
