...
export default function RecordCard({id, content, images, createTime, user}: RecordItemProps) {
    ...
    return (
        <div key={id} className="flex flex-col sm:flex-row">
            <img src={user?.avatar} alt="作者头像" width={56} height={56}
                 className="hidden sm:block rounded-lg border dark:border-black-b h-14 mr-2"/>

            <div className="flex sm:hidden">
                <img src={user?.avatar} alt="作者头像" width={44} height={44}
            ...
            <div className="mt-2 sm:mt-0 w-full">
                ...
                <div
                    className="w-full p-4 border dark:border-black-b rounded-3xl rounded-tl-none bg-[rgba(255,255,255,0.7)] dark:bg-[rgba(30,36,46,0.9)] backdrop-blur-sm">
