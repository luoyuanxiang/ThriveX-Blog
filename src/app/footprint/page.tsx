            ...
            >
                <ModalContent className="bg-[rgba(36,40,45,0.9)]">
                    {() => (
                        <>
                            <ModalHeader
                                className="flex flex-col gap-1 text-center pb-2 text-white">{data?.title}</ModalHeader>
                            <ModalBody>
                                <div className="flex flex-col">
                                    ...
                                    <div
                                        className={`overflow-auto flex justify-center w-full ${data?.images.length !== 1 ? 'max-h-96' : ''} mb-5 hide_sliding`}>
                                        <PhotoProvider
                                            speed={() => 800}
                                            ...
                                            <Masonry breakpointCols={breakpointColumnsObj}
                                                ...
                                                {data?.images?.map((item, index) => (
                                                    <PhotoView src={item} key={index}>
                                                        <img src={item} alt=""
                                                             className="rounded-2xl w-full mb-3 cursor-pointer"/>
                                                    </PhotoView>
                                                ))}
                                            </Masonry>
                                        </PhotoProvider>
