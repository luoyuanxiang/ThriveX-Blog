                                    ...
                                    <div key={index} className="ml-3">
                                        <div className="relative border-l border-gray-300 dark:border-[#4e5969]  ">
                                            <div className="mb-8 ml-4">
                                                <div
                                                    className="absolute w-3 h-3 bg-blue-500 rounded-full -left-1.5 border border-white"></div>
                                                <div className="ml-2 sm:ml-6">
                                                    ...
                                                    {item.month[+month].list.map((article: Article, index) => (
                                                        <div key={index} className="group flex justify-between py-2">
                                                            ...
                                                            <span
                                                                className="hidden sm:flex items-center min-w-24 text-sm text-white group-hover:text-gray-400  ">
