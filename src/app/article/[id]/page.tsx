...
export default async (props: Props) => {
    ...
    const {
        code,
        data
    } = password ? (await getArticleDataAPI(id, password)) || {data: {} as Article} : (await getArticleDataAPI(id)) || {data: {} as Article}
            ...
            <>
                ...
                <div className="ArticlePage">
                    <Slide>
                        ...
                        <div
                            className="absolute w-[80%] sm:w-[70%] lg:w-[60%] xl:w-[50%] top-[60%] md:top-1/2 left-1/2 -translate-x-1/2 -translate-y-[65%] text-white custom_text_shadow">
                            <div
                                className="text-xl mb-5 sm:text-2xl lg:text-3xl xl:text-4xl text-center sm:mb-7 md:mb-10">{data?.title}</div>
                    ...
                    <div className="w-[90%] xl:w-6/12 mx-auto mt-12 relative">
                        ...
                        <div className="w-full">
                            ...
                            {
                                web?.data.globalComment === 'true' && data?.config.comment &&
