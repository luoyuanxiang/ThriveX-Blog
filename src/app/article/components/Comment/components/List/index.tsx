...
const CommentList = forwardRef(({id, reply}: Props, ref) => {
    ...
    return (
        <div className="CommentListComponent">
                    ...
                    {data.result?.map((one) => (
                        <li className="item" key={one.id}>
                            <div className="comment_user_one">
                                {one.avatar ? <img src={one.avatar} alt="" className="avatar"/> :
                                    <RandomAvatar className="avatar"/>}
                                <div className="comment_user_one_info">
                                    {one.url ? (
                                        <a href={one.url} className="name active" target="_blank"
                                ...
                                ? one.children?.map((two) => (
                                    <div className="comment_user_two !ml-5 sm:!ml-12" key={two.id}>
                                        <div className="comment_user_two_info">
                                            {two.avatar ? <img src={two.avatar} alt="" className="avatar"/> :
                                                <RandomAvatar className="avatar"/>}

                                            {two.url ? (
                                                <a href={two.url} className="name active !text-primary" target="_blank"
                                                   rel="noopener noreferrer">
                                                    {two.name}
                                                </a>
                                            ) : (
                                            ...
                                            <span
                                                className="time">{dayjs(+two.createTime).format('YYYY-MM-DD HH:mm')}</span>
                                            ...
                                            <div key={three.id}>
                                                <div className="comment_user_three !ml-5 sm:!ml-12">
                                                    <div className="comment_user_three_info">
                                                        ...
                                                        {three.url ? (
                                                            <a href={three.url} className="name active !text-primary"
                                                        ...
                                                        <span
                                                            className="time">{dayjs(+three.createTime).format('YYYY-MM-DD HH:mm')}</span>
                                                    ...
                                                    <div key={four.id}>
                                                        <div className="comment_user_three !ml-5 sm:!ml-12">
                                                            <div className="comment_user_three_info">
                                                                ...
                                                                <span
                                                                    className="time">{dayjs(+four.createTime).format('YYYY-MM-DD HH:mm')}</span>
                                                        ...
                                                        {four.children?.map((five) => (
                                                            <div key={five.id}
                                                                ...
                                                                <div className="comment_user_three_info">
                                                                    {five.avatar ? <img src={five.avatar} alt=""
                                                                                        className="avatar"/> :
                                                                        <RandomAvatar className="avatar"/>}
                                                                    ...
                                                                    <span
                                                                        className="time">{dayjs(+five.createTime).format('YYYY-MM-DD HH:mm')}</span>
            ...
            {!data.result?.length ? <Empty info="评论列表为空~"></Empty> :
                <Pagination showControls total={data.pages} page={page} onChange={onPaginateChange}
                            className="flex justify-center mt-2" classNames={{
